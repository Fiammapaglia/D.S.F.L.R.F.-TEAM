...
public class ColaPrioridadEstatica implements ColaPrioridadTDA {
    ...
    private static final int MAX = 2; //si el maximo se supera no acola el proximo pero no dice si lo pudo acolar en este programa, en este caso muestra el proceso 1 3 veces
